...
class MyStack(TerraformStack):
    def __init__(self, scope: Construct, ns: str):
        ...
        # Public Instance on Public Subnet - SSH + HTTP
        ...
        # TerraformOutput(self, "pub_instance.security_groups", value=pub_instance.security_groups)

        # Private Instance on Private Subnet - NAT Gateway
        # Amazon Linux 2 AMI (HVM) - Kernel 5.10, SSD Volume Type - ami-08e4e35cccc6189f4 (64-bit x86)
